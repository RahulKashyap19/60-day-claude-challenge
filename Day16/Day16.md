------------Help Text---
- Using the Customize section in claude create a new skill set with below options.
...
------Once this new skill is created, open the chat and click on the + sign, click on skill and select the newly created skill. 
--- Ask question like analyse the One97 stock------------
